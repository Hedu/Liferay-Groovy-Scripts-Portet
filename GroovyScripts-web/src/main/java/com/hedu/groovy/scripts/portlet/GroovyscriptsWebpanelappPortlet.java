package com.hedu.groovy.scripts.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Groovy Scripts Portlet",
...
public class GroovyscriptsWebpanelappPortlet extends MVCPortlet {
}